...
<?php echo $this->Form->create('Entrepreneur'); ?>
	<fieldset>
		<legend><?php echo __('Edit Entrepreneur'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Entrepreneur.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Entrepreneur.id'))); ?></li>
